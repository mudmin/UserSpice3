...
$db_pre_syn="db_table_prefix = 'uc_';";
...
fwrite($fh ,
  $d . $dbh_syn . $dbh . $end . PHP_EOL .
  $d . $dbu_syn . $dbu . $end . PHP_EOL .
  $d . $dbp_syn . $dbp . $end . PHP_EOL .
  $d . $dbn_syn . $dbn . $end . PHP_EOL .
  $d . $db_pre_syn . PHP_EOL
);
